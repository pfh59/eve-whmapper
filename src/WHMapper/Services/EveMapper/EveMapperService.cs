...
public class EveMapperService : IEveMapperService
{
    ...
    public EveMapperService(ILogger<EveMapperService> logger, ICacheService cacheService, IEveAPIServices eveApiService)
    {
        _logger = logger;
        ...
        where T : AEveEntity
    {
        ...
        {
            case "AllianceEntity":
                return Task.FromResult(IEveMapperService.REDIS_ALLIANCE_KEY);
            case "CorporationEntity":
                return Task.FromResult(IEveMapperService.REDIS_COORPORATION_KEY);
            case "CharactereEntity":
                return Task.FromResult(IEveMapperService.REDIS_CHARACTER_KEY);
            case "ShipEntity":
                return Task.FromResult(IEveMapperService.REDIS_SHIP_KEY);
            case "SystemEntity":
                return Task.FromResult(IEveMapperService.REDIS_SYSTEM_KEY);
            case "ConstellationEntity":
                return Task.FromResult(IEveMapperService.REDIS_CONSTELLATION_KEY);
            case "RegionEntity":
                return Task.FromResult(IEveMapperService.REDIS_REGION_KEY);
            case "StargateEntity":
                return Task.FromResult(IEveMapperService.REDIS_STARTGATE_KEY);
            case "GroupEntity":
                return Task.FromResult(IEveMapperService.REDIS_GROUP_KEY);
            case "WHEntity":
                return Task.FromResult(IEveMapperService.REDIS_WORMHOLE_KEY);
            case "SunEntity":
                return Task.FromResult(IEveMapperService.REDIS_SUN_KEY);
            default:
