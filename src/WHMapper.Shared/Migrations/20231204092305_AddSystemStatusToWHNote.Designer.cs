...
namespace WHMapper.Migrations
{
    ...
    [Migration("20231204092305_AddSystemStatusToWHNote")]
    partial class AddSystemStatusToWHNote
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WHMapper.Models.Db.WHAccess", b =>
                {
                    ...
                    b.HasIndex("EveEntityId")
                        .IsUnique();

                    b.HasIndex("EveEntityName")
                        .IsUnique();
